...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "Stunity is a fantastic platform! It not only helped me find a parking spot easily but also allowed me to rent storage space without any hassle. The AI-driven solutions make everything so smooth!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "I love how Stunity simplifies everything. The parking and storage solutions are exactly what I needed, and the platform is incredibly easy to use. Highly recommend it to anyone looking for convenient solutions.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "Stunity has made life so much easier for me. Finding parking used to be a nightmare, but now I can find and rent spots effortlessly. The extra storage options are a huge bonus!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "This platform is a must for students and busy people. Stunity’s AI-driven solutions saved me so much time when I needed storage space and a convenient parking spot. Amazing service!",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "Stunity offers everything you need to simplify your life. The AI solutions make it so easy to rent storage and find parking, and the platform is incredibly user-friendly!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "Stunity has been a real lifesaver! I struggled with finding storage and parking, but now I have both, all thanks to this platform. Highly efficient and easy to navigate!",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "The combination of storage and parking solutions makes Stunity a one-stop platform. The AI-driven tools helped me find exactly what I needed, quickly and easily. Couldn’t be happier!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "I’m so glad I discovered Stunity. It’s made both storage and parking incredibly easy to manage, and the AI features really simplify the entire process. A great tool for anyone!",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "Stunity has exceeded my expectations. Whether it’s finding parking or renting storage space, everything is just a few clicks away. The AI solutions are spot-on and save so much time!",
    categories: [1, 2],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-2xl text-indigo-200/65">
            until you hear from other people*.
          </p>
